...
export const metadata: Metadata = {
  ...
  description:
    '50 field-tested AI prompts for delivery contractors, small fleets, brokers, and 3PLs — RFP teardowns, claims packets, dispatch triage, SOPs, and more. From The AI Operator\'s Playbook by Wiley Strahan. Free.',
  openGraph: {
